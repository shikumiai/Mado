            ...
            >
              ...
              <div className="mt-4">
                ...
                <p className="text-white/60 text-sm mt-3 max-w-[500px] leading-relaxed">
                  これまでにお手伝いした事例の一部をご紹介します。守秘義務の範囲内で、課題と解決策をお伝えします。
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-[900px] mx-auto px-5">
              ...
              {CASES.map((caseItem, i) => (
                ...
                >
                  <Link
                    ...
                    className="block bg-[#F7F6F3] rounded-2xl border border-[#E0DDD8] p-6 sm:p-8 hover:border-[#2B4C3F]/30 hover:shadow-md transition-all group"
                  >
                    <div className="flex items-start justify-between gap-3 mb-4">
                      <span className="inline-block px-3 py-1 rounded-full bg-[#2B4C3F]/10 text-[#2B4C3F] text-xs font-medium">
                        {caseItem.category}
                      </span>
                      <ArrowRight className="w-4 h-4 text-[#6B6B6B] group-hover:text-[#2B4C3F] transition-colors flex-shrink-0" />
                    </div>
                    <h2
                      className="font-bold text-[#1A1A1A] text-lg sm:text-xl mb-3"
                      style={{ fontFamily: "'Noto Serif JP', serif" }}
                    >
                      {caseItem.title}
                    </h2>
                    ...
                    <div className="flex items-center gap-2 text-[#6B6B6B] text-xs">
                      <span className="w-1 h-1 rounded-full bg-[#E0DDD8]" />
            ...
            >
              ...
              <p className="text-[#6B6B6B] text-sm mb-6">
                お客様の状況に合わせた最適な解決策をご提案します。まずはお気軽にご相談ください。
              </p>
