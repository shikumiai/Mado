...
export const TEMPLATES: TemplateDef[] = [
  ...
  /* ─── 4 飲食店 ─── */
  {
    ...
    sections: [
      { type: "hero", variant: "full", label: "メインビジュアル", id: "home" },
      { type: "menu", variant: "photo-cards", label: "看板料理", id: "signature" },
      { type: "menu", variant: "price-table", label: "お品書き", id: "menu", required: true },
