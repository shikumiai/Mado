...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      { source: "/start", destination: "/pilot", permanent: false },
      ...
      {
        source: "/portfolio-templates/pastel-pop",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/retro-pop",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/comic-panel",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/cyber-neon",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/dark-elegance",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/floating-gallery",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/ink-wash",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/mosaic-bold",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/studio-white",
        destination: "/start",
        permanent: true,
      },
      {
        source: "/portfolio-templates/watercolor-soft",
        destination: "/start",
        permanent: true,
      },
      // C6: /test → /（テストページ）
